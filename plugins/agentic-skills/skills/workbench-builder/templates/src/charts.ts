...
// Graphite's MONO_STACK verbatim: chart data reads in the structural face,
// never the body sans. Labels render into canvas, so no CSS floor reaches
// them — LABEL_PX holds them at the theme ramp's 12px minimum by hand.
...
const TOOLTIP = {
  ...
  borderWidth: 1,
  // Widened to number[]: ECharts types padding as a mutable array, and the
  // enclosing `as const` would otherwise hand it a readonly tuple.
